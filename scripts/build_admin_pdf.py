...
story.append(table([
    ...
    ["4", "Xác nhận website", "Sau ít phút, kiểm tra mốc thời gian trên website."],
...
story += [P("3. Cập nhật, phát hành và xử lý lỗi", "H1VN"),
          ...
          P("Hai mốc thời gian cần phân biệt", "H2VN"),
          table([
              ["Hiển thị", "Ý nghĩa"],
              ["Dữ liệu cập nhật 06/2026", "Lấy từ ô C2. Đây là tháng của bộ dữ liệu Hội Đột Quỵ Việt Nam."],
              ["Website cập nhật lúc: hh:mm:ss dd/mm/yyyy", "Thời điểm phiên bản website được workflow phát hành; không phải tháng C2."],
          ], [64 * mm, 100 * mm], background=LIGHT_BLUE),
          table([
              ["Bước", "Việc cần làm"],
              ...
              ["5", "Chờ vài phút để Pages triển khai, sau đó tải lại website."],
          ], [18 * mm, 146 * mm]),
          ...
          bullet("Chờ vài phút, sau đó tải lại bằng Ctrl + F5 hoặc mở cửa sổ riêng tư."),
          bullet("Tab Dấu hiệu phải có thời gian Website cập nhật lúc mới hơn lần trước."),
